...
const components = {
    ...
    block: {
        ...
        h5: ({ children }: any) => <h5 className="text-base font-medium mt-6 mb-2 text-slate-100 tracking-tight">{children}</h5>,
        h6: ({ children }: any) => <h6 className="text-xs font-medium mt-6 mb-1 text-slate-100 tracking-tight">{children}</h6>,
        normal: ({ children }: any) => <p className="text-slate-300 leading-[1.8] sm:mb-6 mb-4 text-[16px] sm:text-lg">{children}</p>,
