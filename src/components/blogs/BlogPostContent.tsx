      ...
      <div className="min-h-screen relative bg-[#212121]/45 pt-32 pb-5 sm:pb-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <Link
              href="/blogs"
              className="inline-flex items-center text-slate-300 hover:text-[#8ef3c1] font-semibold mb-6 sm:mb-10 transition-all group"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 xl:gap-20">
            ...
            >
              <header className="mb-12">
                ...
                >
                  {categories.map((cat: string, i: number) => (
                    <span
                      key={i}
                      className="px-5 py-2 text-[10px] font-black uppercase tracking-[0.2em] rounded-lg bg-white/5 border border-white/15 text-slate-200"
                    >
                      {cat}
                    </span>
                  ))}
                ...
                <m.h1
                  variants={fadeInUp}
                  className="text-2xl sm:text-3xl md:text-4xl font-black text-slate-100 leading-[1.1] mb-8 tracking-wide sm:tracking-tight"
                >
                  {post.title}
                </m.h1>
                ...
                {post.mainImage && (
                  <m.div
                    variants={fadeInUp}
                    className="relative w-full aspect-[16/9] rounded-3xl overflow-hidden border border-white/5 shadow-2xl shadow-black/50 mb-10 sm:mb-16 bg-[#020617]/40"
                  >
                    <Image
              ...
              <m.div
                variants={fadeInUp}
                className="py-6 sm:py-12 flex flex-col items-center gap-6 border-b border-white/30"
              >
          ...
          {post.relatedPosts && post.relatedPosts.length > 0 && (
            ...
            >
              <div className="flex items-center justify-between mb-8 sm:mb-12">
                ...
                <Link
                  href="/blogs"
                  className="text-sm font-semibold tracking-wider text-[#8ef3c1] hover:underline"
                >
