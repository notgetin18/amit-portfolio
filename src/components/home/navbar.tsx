...
//               <button
//                 onClick={toggleMenu}
//                 className="text-white border border-white/30 shadow-lg shadow-white/20 transition-colors duration-300 hover:text-[#3ed6ac] inset-0 bg-gradient-to-tr from-black/30 via-transparent to-black/10 mix-blend-overlay rounded-md p-2 shadow-lg shadow-black/50"
//                 aria-label={isMenuOpen ? "Close menu" : "Open menu"}
//               >
//                 {isMenuOpen ? (
//                   <X className="w-6 h-6 text-white" />
