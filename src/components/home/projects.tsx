                ...
                <CardContent className="p-4 relative z-20 min-h-[340px] flex flex-col justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <Button
                        size="sm"
                        className="bg-white/8 hover:bg-white/10 shadow-sm border border-white/6 flex items-center gap-2"
                    ...
                    >
                      <Button
                        size="sm"
                        className="bg-gradient-to-tr from-[#06b6d4] via-[#34d399] to-[#8ef3c1] text-black font-medium shadow-lg hover:scale-[1.03] transition-transform"
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex gap-2">
                        ...
                        >
                          <Button
                            size="sm"
                            className="bg-gradient-to-tr from-[#bd4204] to-[#d47406] text-gray-200"
                          >
                            Live Demo
                          </Button>
                        </a>
