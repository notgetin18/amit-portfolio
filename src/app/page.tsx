            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
                <div className="lg:col-span-7 px-2 sm:px-6">
                  <div className="inline-flex items-center text-sm text-slate-400 uppercase tracking-widest rounded-full bg-gradient-to-r from-white/5 via-white/3 to-transparent px-3 py-1 mb-3">
                  ...
                  <div className="mt-6 flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                    <Link href="/contact" className="w-full sm:w-auto">
                      <PrimaryButtons
                        ...
                        containerStyles="px-8 py-3 rounded-3xl text-lg font-medium w-full sm:w-auto"
                      />
                    </Link>
                  ...
                  <div className="w-full max-w-[420px] rounded-2xl overflow-hidden border border-white/6 bg-gradient-to-br from-white/5 to-transparent p-4 backdrop-blur-sm shadow-lg">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-slate-300 mt-1">
                          15–30 minute discovery to scope your project &
                          outcomes
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mt-4 flex gap-3">
                      <Link href="/contact" className="flex-1">
                        <PrimaryButtons
                          title="Book call"
                          containerStyles="px-4 py-2 rounded-xl w-full text-sm"
                        />
                      </Link>
