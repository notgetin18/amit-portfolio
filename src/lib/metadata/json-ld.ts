...
export const PERSON_SCHEMA = {
  ...
  "knowsAbout": [
    "MERN Stack", "React", "Next.js", "Node.js", "MongoDB", "TypeScript", "FinTech Development", "SaaS Architecture"
  ]
};
...
export function generateSoftwareAppSchema() {
  return {
    ...
    "author": { "@id": PERSON_ID },
    "description": "A high-scale digital gold platform built with Next.js and MERN stack for 1M+ users."
  };
}
...
export function generateBlogSchema() {
  return {
    ...
    "description": "Deep-dives into MERN stack development, high-performance web engineering, and digital innovation.",
    "publisher": {
      "@type": "Organization",
...
export function generateContactPageSchema() {
  return {
    ...
    "description": "Get in touch with Amit Kumar for MERN stack development and SEO services.",
    "mainEntity": { "@id": PERSON_ID }
  };
}
